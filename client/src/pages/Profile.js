    ...
    <>
      ...
      <main>
        {topArtists && topTracks && playlists ? (
          <>
            <SectionWrapper title="Top artistas de este mes" seeAllLink="/top-artists">
              <ArtistsGrid artists={topArtists.items.slice(0, 10)} />
            </SectionWrapper>

            <SectionWrapper title="Top canciones de este mes" seeAllLink="/top-tracks">
              <TrackList tracks={topTracks.items.slice(0, 10)} />
            </SectionWrapper>

            <SectionWrapper title="Playlists públicas" seeAllLink="/playlists">
